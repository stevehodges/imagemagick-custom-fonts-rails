#!/usr/bin/perl -w
# Rails Devs:
#   It is strongly recommended that you do not modify this script.
#   This is verbatim from a main ImageMagick contributor
#   Source: https://www.imagemagick.org/Usage/scripts/imagick_type_gen
#
